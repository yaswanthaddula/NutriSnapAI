            ...
            return filteredReminders.map((reminder: any, index: number) => {
              ...
              return (
                <View key={index} style={{
                    ...
                    <View style={{ flex: 1 }}>
                      ...
                      {timeStr ? (
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                          ...
                          <Text style={{ fontSize: 13, color: theme.subText, marginLeft: 4 }}>{timeStr}</Text>
                        </View>
                      ) : null}
                    </View>
                  ...
                  <Text style={{ fontSize: 14, color: theme.subText, lineHeight: 20, marginBottom: 16 }}>{description}</Text>
                  ...
                  <View style={{ flexDirection: 'row', justifyContent: 'flex-end', gap: 8 }}>
                    ...
                    >
                      <Ionicons name="close-circle-outline" size={16} color={theme.subText} style={{ marginRight: 4 }} />
                      <Text style={{ color: theme.subText, fontSize: 13, fontWeight: '700' }}>Dismiss</Text>
                    </TouchableOpacity>
                  </View>
                </View>
              );
