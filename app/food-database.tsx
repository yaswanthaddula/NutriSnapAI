...
/**
 * Food Database Screen (Gym Mode) - Manual search fallback.
 * Synchronized with the beautiful health-search UI.
 */
export default function FoodDatabaseScreen() {
  ...
  // Debounce logic for search (400ms)
  useEffect(() => {
  ...
  const handleSelectFood = async (food: any) => {
    try {
      ...
      // Fallback: If detail fails, use what we have from search results
